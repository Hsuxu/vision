...
def roi_align3d(
    ...
    Args:
        ...
        output_size (int or Tuple[int, int, int]): the size of the output after the cropping
            is performed, as (depth, height, width)
    ...
    return torch.ops.torchvision.roi_align3d(input, rois, spatial_scale,
...
class RoIAlign3d(nn.Module):
    ...
    def forward(self, input: Tensor, rois: Tensor) -> Tensor:
        return roi_align3d(input, rois, self.output_size, self.spatial_scale, self.sampling_ratio, self.aligned)
